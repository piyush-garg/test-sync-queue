...
IMPORTANT: As part of the process of creating this booster, developers.redhat.com/launch or the Fabric8 Launcher tool set up a project with a CI/CD deployment of this bline Web Console.

== Running the Booster Locally

[source,bash,options="nowrap",subs="attributes+"]
----
$ git clone git@github.com:piyush1594/test-sync-queue
